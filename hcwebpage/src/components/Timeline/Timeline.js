...
const Timeline = (props) => {
    return (
        <div className={styles.timeline}>
            <ul>
                <TimelineItem title="Data Analyst Intern" time="Dec 2020" child={1}>Interned at MOH as a Data Analyst for 3 months, handling information related to COVID operations. My team primarily uses Stata in our operations</TimelineItem>
